...
const ulong CLIENT_PTR           = 0xE1E198;
const ulong MOUSE_HOOK           = 0xE188D0;
...
const ulong FN_RENDER_MENU_ENTRY = 0x47E0B0;
// 48 8B 99 ? ? ? ? 48 3B 99 20 98 01 00 74 24
const ulong FN_SET_CLIENT_STATE  = 0x261A0;
// 44 89 44 24 ? 53 41 55
const ulong FN_RUN_SCRIPT        = 0x8A090;
// 40 55 41 54 41 55 41 56 41 57 48 8D AC 24
const ulong FN_ADD_ENTRY_INNER   = 0x15D0D0;
// 48 89 5C 24 ? 4C 8B 59 ? 44 8D 14 12
const ulong FN_GET_INVENTORY     = 0x2FBFA0;
// 44 88 44 24 ? 89 54 24 ? 56
const ulong FN_GET_COMP_BY_ID    = 0x334160;
...
const ulong OF_PLAYER_LIST       = 0x19910;
const ulong OF_INVENTORY         = 0x19980;
const ulong OF_SKILL_MANAGER     = 0x198E0;
const ulong OF_CHAT_HISTORY      = 0x19840;
const ulong OF_INTERFACE         = 0x198C0;